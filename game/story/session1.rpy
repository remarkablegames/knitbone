label session1:
    ...
    "3B, just like the card said. That’s the room I’ve been trying to track down."
    ...
    show ryohei neutral with moveinbottom
    pause 1
    ryohei "Eden!"
...
label session1_studio:
    ...
    "I sat on a couch where the table in front of me was taller than I thought, across from it was a single ergonomic chair for Ryohei, making it feel less like a living room and more like a private discussion space."

    ryohei "So, you know why you’re here, right?"
    pause 1
    eden "{cps=10}... Yes."

    ryohei "Alright. Let’s get straight to the point. Tell me, in your own words, what brought you here tonight."
    ...
    ryohei "Insomnia and identity crisis. That’s a reasonable set to bring in together. Sleep and sense of self are closer than most think."
...
label session1_test:
    menu:
        ...
        "Yes":
            eden "Okay... let’s do it."
            ryohei "Good. Don’t worry, it’s simple and not invasive. Just answer honestly."

            jump personality_test

        "No":
            eden "{cps=15}I...{w=0.3} I don’t think I’m ready yet."

            ryohei "Hmm... Is that so?"
...
label session1_end:
    ...
    ryohei "What I’m going to propose may feel unfamiliar at first. A method, not exactly therapy, not exactly ritual either... Perhaps, somewhere in between."
