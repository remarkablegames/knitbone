# TODO: Translation updated at 2026-02-20 03:15
...
translate russian strings:
    ...
    new "Падение громкости при автоозвучке"
    ...
    new "Меню доступности. Используйте стрелки вверх и вниз для навигации, клавишу Enter для активации кнопок и полос."
    ...
    new "Опции в этом меню предназначены для улучшения доступности. Они могут работать не во всех играх, а некоторые комбинации опций могут сделать игру непроходимой. Это не проблема игры или движка. Для достижения наилучших результатов при изменении шрифтов старайтесь сохранять размер текста таким же, как был изначально."
    ...
    new "Ячейка сохранения %s: [text]"

    # renpy/common/00action_file.rpy:481
    old "Load slot %s: [text]"
    new "Загрузка сохранения %s: [text]"

    # renpy/common/00action_file.rpy:534
    old "Delete slot [text]"
    new "Удалить сохранение [text]"

    # renpy/common/00action_file.rpy:613
    old "File page auto"
    new "Автоматическая страница файлов"
    ...
    new "Щёлкните, чтобы переключить атрибут, щёлкните правой кнопкой для переключения отрицательного атрибута."
    ...
    new "Щёлкните, чтобы установить преобразование, щёлкните правой кнопкой, чтобы добавить в список преобразований."
    ...
    new "Эта сохранённая игра была создана на другом устройстве. Злонамеренно созданные файлы сохранения могут нанести вред вашему компьютеру. Доверяете ли вы создателю сохранения и всем, кто мог изменить файл?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "Доверяете ли вы устройству, на котором было создано сохранение? Выбирайте \"да\" только если вы единственный пользователь этого устройства."
    ...
    new "Эта программа содержит свободное программное обеспечение под несколькими лицензиями, включая лицензию MIT и GNU Lesser General Public License. Полный список программного обеспечения, включая ссылки на полный исходный код, можно найти {a=https://www.renpy.org/l/license}здесь{/a}."
    ...
    new "автоматический пропуск времени"

    # renpy/common/00preferences.rpy:396
    old "auto-forward"
    new "автоматическое пролистывание"
    ...
    new "автоматическое пролистывание после клика"
    ...
    old "self voicing"
    new "собственное озвучивание"

    # renpy/common/00preferences.rpy:445
    old "self voicing enable"
    new "включить собственное озвучивание"

    # renpy/common/00preferences.rpy:447
    old "self voicing disable"
    new "отключить собственное озвучивание"
    ...
    new "Самоозвучивание произнесло бы \"[renpy.display.tts.last]\". Нажмите 'alt+shift+V' для отключения."
    ...
    new "Истекло время ожидания ответа от сервера синхронизации Ren'Py."
    ...
    new "На сервере синхронизации Ren'Py нет копии этой синхронизации. ID синхронизации может быть недействительным или истёк срок его действия."
    ...
    new "ID синхронизации указан в неверном формате."
    ...
    new "Это установит соединение с {a=https://sync.renpy.org}сервером синхронизации Ren'Py{/a}."
    ...
    new "Хеш-сумма списка файлов не совпадает."
    ...
    new "Либо этот проект не поддерживает обновление, либо файл состояния обновления был удалён."
    ...
    new "Файл обновления имеет неправильную хеш-сумму — возможно, он повреждён."
    ...
    new "Эта программа обновлена до последней версии."
    ...
    new "Эту игру нельзя запустить, пока не будут загружены данные игры."
    ...
    new "Для этой игры требуется использование GL2, которое не может быть инициализировано."
    ...
    new "Драйверы графики могут быть устаревшими или работать некорректно. Это может привести к медленному или некорректному отображению графики."
    ...
    new "зменить параметры рендеринга"
    ...
    new "Пытается откатить игру к предыдущему моменту времени, позволяя вам сохранить игру или выбрать другой вариант действия."
    ...
    new "Игнорирует ошибку, позволяя вам продолжить игру."

    # renpy/common/_errorhandling.rpym:840
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Игнорирует ошибку, позволяя вам продолжить игру. Часто это приводит к дополнительным ошибкам."
    ...
    new "Ошибка при разборе скрипта."
